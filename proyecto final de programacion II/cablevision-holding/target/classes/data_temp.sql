-- Script de inserción de datos de ejemplo para Cablevision Holding (H2)
...
INSERT INTO ASESOREMPRESAREA (asesor_id, empresa_id, area_mercado_id) VALUES (1, 1, 1), (1, 2, 2);

INSERT INTO CUENTAS (numeroCuenta, pin, saldo, activa, fecha_creacion, ultima_actualizacion)
VALUES ('10001', '1234', 5000.00, true, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO CUENTAS (numeroCuenta, pin, saldo, activa, fecha_creacion, ultima_actualizacion)
VALUES ('10002', '5678', 2500.00, true, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
